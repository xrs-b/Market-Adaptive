...
class MarketAdaptiveBootstrapTests(unittest.TestCase):
    def test_load_config_contains_okx_demo_headers(self) -> None:
        ...
        self.assertEqual(config.grid.min_spacing_ratio, 0.008)
        ...
        self.assertEqual(config.cta.weak_bull_memory_score_bonus, 0.20)
        self.assertEqual(config.cta.early_bullish_score_bonus, 0.15)
