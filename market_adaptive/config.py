...
class CTAConfig:
    ...
    strong_bull_bias_score: float = 50.0
    weak_bull_bias_score: float = 20.0
    weak_bull_memory_score_bonus: float = 10.0
    dynamic_rsi_trend_score: float = 15.0
    dynamic_rsi_rebound_score: float = 20.0
    early_bullish_score_bonus: float = 15.0
    swing_supertrend_bullish_score: float = 30.0
    magnetism_score_bonus: float = 30.0
    kdj_memory_score_bonus: float = 20.0
    rail_momentum_score_bonus: float = 25.0
...
def load_config(config_path: str | Path) -> AppConfig:
    ...
    cta = CTAConfig(
        ...
        strong_bull_bias_score=float(cta_payload.get("strong_bull_bias_score", 50.0)),
        weak_bull_bias_score=float(cta_payload.get("weak_bull_bias_score", 20.0)),
        weak_bull_memory_score_bonus=float(cta_payload.get("weak_bull_memory_score_bonus", 10.0)),
        dynamic_rsi_trend_score=float(cta_payload.get("dynamic_rsi_trend_score", 15.0)),
        dynamic_rsi_rebound_score=float(cta_payload.get("dynamic_rsi_rebound_score", 20.0)),
        early_bullish_score_bonus=float(cta_payload.get("early_bullish_score_bonus", 15.0)),
        swing_supertrend_bullish_score=float(cta_payload.get("swing_supertrend_bullish_score", 30.0)),
        magnetism_score_bonus=float(cta_payload.get("magnetism_score_bonus", 30.0)),
        kdj_memory_score_bonus=float(cta_payload.get("kdj_memory_score_bonus", 20.0)),
        rail_momentum_score_bonus=float(cta_payload.get("rail_momentum_score_bonus", 25.0)),
